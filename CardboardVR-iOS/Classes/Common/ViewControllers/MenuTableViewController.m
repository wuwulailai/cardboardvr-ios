...
- (void)viewDidLoad
{
    ...
    self.tableView.tableHeaderView = ({
        ...
        label.text = NSLocalizedString(@"a simple powerful video player", nil);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && indexPath.row == 3) {
        ...
        StereoCubeViewController *secondViewController = [[StereoCubeViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        NSArray *titles = @[NSLocalizedString(@"Local Video", nil), NSLocalizedString(@"Network Video", nil), NSLocalizedString(@"Cardboard VR", nil),NSLocalizedString(@"More", nil)];
