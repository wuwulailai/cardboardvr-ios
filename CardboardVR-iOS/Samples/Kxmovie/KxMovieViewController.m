...
- (void)loadView
{
    ...
    movieOrientation=MovieOrientationPortrait;
...
/**
 *  修改infoButton的方法为旋转屏幕 2015-0825 add by coderyi
 *
 *  @param sender
 */
...
//
    ...
    if (    movieOrientation==MovieOrientationPortrait) {
        ...
        movieOrientation=MovieOrientationLandscape;
